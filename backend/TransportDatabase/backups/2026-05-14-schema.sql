...
\restrict aeQfOVEoJniehiaO8RWgThkZMVzDwTsB1vw8vjkLGwfqS5Ov5xGVOegXjwnVQkZ
...
CREATE MATERIALIZED VIEW public.active_stop_departures AS
 SELECT DISTINCT ON (t.trip_id, st.stop_sequence) t.trip_id,
    t.trip_headsign,
    t.service_id,
    c.monday,
    c.tuesday,
    ...
    st.stop_sequence
   FROM (((public.trips t
     LEFT JOIN public.calendars c ON ((c.service_id = t.service_id)))
...
--
-- Name: runs; Type: TABLE; Schema: public; Owner: user
--

CREATE TABLE public.runs (
    run_sequence_a text CONSTRAINT runs_run_number_not_null NOT NULL,
    run_sequence_b text CONSTRAINT runs_run_letter_not_null NOT NULL,
    trip_id text NOT NULL,
    vehicle_id text,
...
ALTER TABLE public.runs OWNER TO "user";
...
--
-- Name: vehicle_boardings_id_seq; Type: SEQUENCE; Schema: public; Owner: user
--

CREATE SEQUENCE public.vehicle_boardings_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE public.vehicle_boardings_id_seq OWNER TO "user";

--
-- Name: vehicle_boardings_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: user
--

ALTER SEQUENCE public.vehicle_boardings_id_seq OWNED BY public.vehicle_boardings.id;
...
--
-- Name: vehicle_boardings id; Type: DEFAULT; Schema: public; Owner: user
--

ALTER TABLE ONLY public.vehicle_boardings ALTER COLUMN id SET DEFAULT nextval('public.vehicle_boardings_id_seq'::regclass);
...
--
-- Name: runs runs_pkey; Type: CONSTRAINT; Schema: public; Owner: user
--

ALTER TABLE ONLY public.runs
    ADD CONSTRAINT runs_pkey PRIMARY KEY (run_sequence_a, run_sequence_b);
...
ALTER TABLE ONLY public.stops
    ADD CONSTRAINT stops_pkey PRIMARY KEY (stop_id, route_type);
...
ALTER TABLE ONLY public.vehicle_boardings
    ADD CONSTRAINT vehicle_boardings_pkey PRIMARY KEY (id);
...
ALTER TABLE ONLY public.vehicle_categories
    ADD CONSTRAINT vehicle_categories_pkey PRIMARY KEY (vehicle_category_id, vehicle_category_name);
...
--
-- Name: idx_consist_trip_timestamp; Type: INDEX; Schema: public; Owner: user
--

CREATE INDEX idx_consist_trip_timestamp ON public.consist USING btree (trip_id, "timestamp" DESC);
...
--
-- Name: idx_stop_times_trip_sequence; Type: INDEX; Schema: public; Owner: user
--

CREATE INDEX idx_stop_times_trip_sequence ON public.stop_times USING btree (trip_id, stop_sequence DESC);
...
--
-- Name: idx_stop_updates_trip_stop_timestamp; Type: INDEX; Schema: public; Owner: user
--

CREATE INDEX idx_stop_updates_trip_stop_timestamp ON public.stop_time_updates USING btree (trip_id, stop_id, "timestamp" DESC);
...
--
-- Name: vehicle_boardings_unique; Type: INDEX; Schema: public; Owner: user
--

CREATE UNIQUE INDEX vehicle_boardings_unique ON public.vehicle_boardings USING btree (vehicle_category_id, child_sequence, grandchild_sequence, boarding_area_id);
...
--
-- Name: stop_times stop_times_stop_id_route_type_fkey; Type: FK CONSTRAINT; Schema: public; Owner: user
--

ALTER TABLE ONLY public.stop_times
    ADD CONSTRAINT stop_times_stop_id_route_type_fkey FOREIGN KEY (stop_id, route_type) REFERENCES public.stops(stop_id, route_type) ON DELETE CASCADE;
...
\unrestrict aeQfOVEoJniehiaO8RWgThkZMVzDwTsB1vw8vjkLGwfqS5Ov5xGVOegXjwnVQkZ
