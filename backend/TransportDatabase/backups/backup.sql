...
\restrict 62kWLT2HlY53QSMWoMEly8t1X7q1Y94Uwx8tzNR4fHuk7kQhzGsRyre3IABmZDE
...
ALTER TABLE ONLY public.occupancies
    ADD CONSTRAINT occupancies_trip_id_fkey FOREIGN KEY (trip_id) REFERENCES public.trips(trip_id) ON DELETE CASCADE;
...
\unrestrict 62kWLT2HlY53QSMWoMEly8t1X7q1Y94Uwx8tzNR4fHuk7kQhzGsRyre3IABmZDE
