...
\restrict 9gMR5eQCl8QOX2zmkaZKLVK3fkHFmrJXRTSFesJMeLK2FAhlPfnwg8mBEH0s6fB
...
--
-- Name: carriage_occupancies; Type: TABLE; Schema: public; Owner: user
--

CREATE TABLE public.carriage_occupancies (
    trip_id text CONSTRAINT carriage_sequence_predictive_occupancies_trip_id_not_null NOT NULL,
    stop_id text CONSTRAINT carriage_sequence_predictive_occupancies_stop_id_not_null NOT NULL,
    position_in_consist integer CONSTRAINT carriage_sequence_predictive_occup_position_in_consist_not_null NOT NULL,
    departure_occupancy_status text CONSTRAINT carriage_sequence_predictiv_departure_occupancy_status_not_null NOT NULL
);


ALTER TABLE public.carriage_occupancies OWNER TO "user";
...
--
-- Name: occupancies; Type: TABLE; Schema: public; Owner: user
--
...
ALTER TABLE public.occupancies OWNER TO "user";
...
CREATE TABLE public.shapes (
    ...
    shape_geom public.geography(Point,4326) CONSTRAINT shapes_geom_not_null NOT NULL,
...
CREATE TABLE public.stops (
    ...
    stop_geom public.geography(Point,4326) CONSTRAINT stops_geom_not_null NOT NULL,
    stop_zone_id text,
    stop_url text,
    stop_location_type smallint CONSTRAINT stops_location_type_not_null NOT NULL,
    stop_parent_station text,
    stop_timezone text,
    stop_wheelchair_boarding smallint CONSTRAINT stops_wheelchair_boarding_not_null NOT NULL,
...
CREATE TABLE public.vehicle_boardings (
    ...
    boarding_area_id integer NOT NULL
);
...
--
-- Name: carriage_occupancies carriage_sequence_predictive_occupancies_pkey; Type: CONSTRAINT; Schema: public; Owner: user
--

ALTER TABLE ONLY public.carriage_occupancies
    ADD CONSTRAINT carriage_sequence_predictive_occupancies_pkey PRIMARY KEY (trip_id, stop_id, position_in_consist);
...
ALTER TABLE ONLY public.consist
    ADD CONSTRAINT consist_pkey PRIMARY KEY (vehicle_id, position_in_consist, "timestamp");
...
--
-- Name: occupancies occupancies_pkey; Type: CONSTRAINT; Schema: public; Owner: user
--

ALTER TABLE ONLY public.occupancies
    ADD CONSTRAINT occupancies_pkey PRIMARY KEY (trip_id, stop_sequence, start_date);
...
ALTER TABLE ONLY public.stops
    ADD CONSTRAINT stops_pkey PRIMARY KEY (stop_id, mode);
...
--
-- Name: idx_calendar_end_date; Type: INDEX; Schema: public; Owner: user
--

CREATE INDEX idx_calendar_end_date ON public.calendars USING btree (end_date);


--
-- Name: idx_calendar_start_date; Type: INDEX; Schema: public; Owner: user
--

CREATE INDEX idx_calendar_start_date ON public.calendars USING btree (start_date);


--
-- Name: idx_shapes_geom; Type: INDEX; Schema: public; Owner: user
--

CREATE INDEX idx_shapes_geom ON public.shapes USING gist (shape_geom);


--
-- Name: idx_vehicle_positions_geom; Type: INDEX; Schema: public; Owner: user
--

CREATE INDEX idx_vehicle_positions_geom ON public.vehicle_positions USING gist (position_geom);


--
-- Name: carriage_occupancies carriage_sequence_predictive_occupancies_trip_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: user
--

ALTER TABLE ONLY public.carriage_occupancies
    ADD CONSTRAINT carriage_sequence_predictive_occupancies_trip_id_fkey FOREIGN KEY (trip_id) REFERENCES public.trip_updates(trip_id) ON DELETE CASCADE;


--
-- Name: carriage_occupancies carriage_sequence_predictive_occupancies_trip_id_stop_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: user
--

ALTER TABLE ONLY public.carriage_occupancies
    ADD CONSTRAINT carriage_sequence_predictive_occupancies_trip_id_stop_id_fkey FOREIGN KEY (trip_id, stop_id) REFERENCES public.stop_time_updates(trip_id, stop_id) ON DELETE CASCADE;
...
--
-- Name: occupancies occupancies_trip_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: user
--

ALTER TABLE ONLY public.occupancies
    ADD CONSTRAINT occupancies_trip_id_fkey FOREIGN KEY (trip_id) REFERENCES public.trips(trip_id);


--
-- Name: occupancies occupancies_trip_id_stop_sequence_fkey; Type: FK CONSTRAINT; Schema: public; Owner: user
--

ALTER TABLE ONLY public.occupancies
    ADD CONSTRAINT occupancies_trip_id_stop_sequence_fkey FOREIGN KEY (trip_id, stop_sequence) REFERENCES public.stop_times(trip_id, stop_sequence);
...
--
-- Name: stop_times stop_times_stop_id_mode_fkey; Type: FK CONSTRAINT; Schema: public; Owner: user
--

ALTER TABLE ONLY public.stop_times
    ADD CONSTRAINT stop_times_stop_id_mode_fkey FOREIGN KEY (stop_id, mode) REFERENCES public.stops(stop_id, mode);
...
--
-- Name: trips trips_service_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: user
--

ALTER TABLE ONLY public.trips
    ADD CONSTRAINT trips_service_id_fkey FOREIGN KEY (service_id) REFERENCES public.calendars(service_id) ON DELETE CASCADE;
...
\unrestrict 9gMR5eQCl8QOX2zmkaZKLVK3fkHFmrJXRTSFesJMeLK2FAhlPfnwg8mBEH0s6fB
