...
public class SydneyMetroController : ControllerBase
{
    ...
    [HttpGet("stop-times")]
    public async Task<ActionResult<List<StopTimeDto>>> GetSydneyMetroStopTimes(string stopName, string timeString, bool before)
    {
    ...
    private async Task<Dictionary<string, string>> GetSydneyMetroTripHeadsigns(HashSet<string> tripIds)
    {
