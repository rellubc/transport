...
func InsertVehiclePositionsV1(feed *pb.FeedMessage, db *pgxpool.Pool, mode string) error {
...
func InsertTripUpdatesV1(feed *pb.FeedMessage, db *pgxpool.Pool, mode string) error {
	ctx := context.Background()
