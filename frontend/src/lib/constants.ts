export const MODE_TYPE_LIGHT_RAIL = 0
export const MODE_TYPE_METRO = 401
export const MODE_TYPE_RAIL = 2
export const MODE_TYPE_BUS = 3
export const MODE_TYPE_FERRY = 4
